...
In my quest to keep upto date with the big ideas in econometrics and finance I
...
been gained from similar methods applied to e-marketing (see `Patrick McKenzie's
essays <http://www.kalzumeus.com/greatest-hits/>`_ for more).

Another paper of note was `Predicting the Present with Bayesian Strucural Time
Series
